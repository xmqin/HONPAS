...
! get the local prefactor, we'll now use the largest density matrix element of
! the block to screen
...
!> \retval radius Calculated radius of the Gaussian function
!> \date    26.02.1999
!> \par History
...
!> \version 1.0
! *****************************************************************************
  FUNCTION exp_radius2(l, alpha,threshold,prefactor,epsin) RESULT(radius)
...
!>      can optionally screen by the maximum element of the pab block
! *****************************************************************************
  FUNCTION exp_radius_very_extended2(la_min, la_max, lb_min, lb_max, &
...
&     RESULT(radius)
  ...
  END FUNCTION exp_radius_very_extended2
