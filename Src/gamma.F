...
! **************************************************************************************************
   SUBROUTINE create_md_ftable(nmax, tmin, tmax, tdelta)
      ...
      IF (current_nmax > -1) THEN
        write(6,*) " Errors : An incomplete Gamma function table is already allocated "
      END IF

      IF (nmax < 0) THEN
        write(6,*) " Errors : A negative n value for the initialization of the  &
...
!         CPABORT("Invalid arguments")
          write(6,*) 'err to stop: Invalid arguments'
      END IF
...
!      CHARACTER(len=*), PARAMETER :: routineN = 'fgamma_ref', routineP = moduleN//':'//routineN
...
!           *** No convergence with kmax iterations ***
           ...
           write(6,*) "Err: Maximum number of iterations reached"
...
!      CHARACTER(len=*), PARAMETER :: routineN = 'init_md_ftable', routineP = moduleN//':'//routineN

      IF (nmax < 0) THEN
       write(6,*) 'Err: A negative n value for the initialize incomplete Gamma function is invalid'
       stop
